...
class MockProvider:
    ...
    async def complete(
        ...
        json_output = os.environ.get("BLOGFORGE_MOCK_OUTPUT_JSON")
        text_output = os.environ.get("BLOGFORGE_MOCK_OUTPUT", "Hello from the mock.")
    ...
    async def stream(self, *, model: str, prompt: str) -> AsyncIterator[StreamChunk]:
        text = os.environ.get("BLOGFORGE_MOCK_OUTPUT", "Hello from the mock.")
